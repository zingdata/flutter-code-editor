...
class CodeController extends TextEditingController {
  ...
  // Flag to prevent triggering suggestion generation when inserting a word
  bool isInsertingWord = false;
  ...
  late final WordInsertionHelper _wordInsertionHelper;
  late final SuggestionHelper _suggestionHelper;
  ...
  Future<void> generateSuggestions() async {
    return _suggestionHelper.generateSuggestions();
  }
  ...
  set value(TextEditingValue newValue) {
    ...
    if (hasTextChanged && !isInsertingWord) {
  ...
  /// Gets the current visible section names.
  Set<String> get visibleSectionNames => _visibleSectionNames;

  /// Sets the visible section names.
  ///
  /// When not empty, only the named sections in this set are shown.
  ...
  /// Folds code at the specified line number
  ///
  /// This creates a fold at the given line, hiding the block of code
  /// that starts at this line. A fold toggle will be displayed in the gutter.
  ...
  /// Unfolds code at the specified line number
  ///
  /// This removes a fold at the given line, showing the previously hidden
  /// block of code that starts at this line.
